    ...
    <div v-if="type === 'group'">
      ...
      >
        <div class="active-content" v-if="activeGroupUser[activeRoom.groupId]">
          <div class="actiev-content-title">Group information</div>
          <div class="active-content-sum">online users: {{ activeNum }}</div>
          ...
          <a-button type="danger" class="active-content-out" @click="exitGroup">exit</a-button>
        </div>
      </a-drawer>
    </div>
    <div v-else>
