<template>
  <div class="tool">
    ...
    <a-tooltip placement="topLeft" arrow-point-at-center>
      <div slot="title">
        <div>Screenshot, paste and send pictures</div>
      </div>
      <a-icon type="bulb" class="tool-tip icon" />
    </a-tooltip>
    <a-icon type="skin" class="tool-skin icon" @click="showBackgroundModal = true" />
    <a href="https://github.com/constantin942/epic-chat" target="_blank" class="tool-github icon"><a-icon type="github"/></a>
    ...
    <a-modal title="User info" :visible="showUserModal" footer="" @cancel="showUserModal = false">
      <div class="tool-user">
        ...
        <div class="tool-user-info">
          <div class="tool-user-title">*name</div>
          <a-input class="tool-user-input" v-model="username" placeholder="Please enter the username"></a-input>
          <a-button type="primary" @click="changeUserName">change</a-button>
        </div>
        <div class="tool-user-info">
          <div class="tool-user-title">*password</div>
          <a-input-password class="tool-user-input" v-model="password" placeholder="Please enter the password"></a-input-password>
          <a-button type="primary" @click="changePassword">change</a-button>
        </div>
      </div>
    </a-modal>
    <a-modal title="Theme" :visible="showBackgroundModal" footer="" @cancel="showBackgroundModal = false">
      <div class="tool-user-info">
        <div class="tool-user-title" style="width: 65px;">
          ...
          <a-tooltip placement="topLeft" arrow-point-at-center>
            <div slot="title">
              <span>default background for empty context, supports jpg, png, gif and other formats</span>
            </div>
            <a-icon type="exclamation-circle" style="margin-left: 5px;" />
          </a-tooltip>
        </div>
        <a-input v-model="background" class="tool-user-input" placeholder="URL of Picture"></a-input>
