  ...
  <div class="search">
    <div class="search-select">
      ...
      <a-dropdown class="search-dropdown">
        ...
        <a-menu slot="overlay">
          <a-menu-item>
            <div @click="() => (visibleAddGroup = !visibleAddGroup)">Create new group</div>
          </a-menu-item>
          <a-menu-item>
            <div @click="() => (visibleJoinGroup = !visibleJoinGroup)">Search group</div>
          </a-menu-item>
          <a-menu-item>
            <div @click="() => (visibleAddFriend = !visibleAddFriend)">Search user</div>
          </a-menu-item>
        </a-menu>
      </a-dropdown>
    </div>

    <a-modal v-model="visibleAddGroup" footer="" title="Create new group">
      <div style="display:flex">
        <a-input v-model="groupName" placeholder="Enter the name of group"></a-input>
        <a-button @click="addGroup" type="primary">Confirm</a-button>
      </div>
    </a-modal>
    <a-modal v-model="visibleJoinGroup" footer="" title="Search group">
      <div style="display:flex" v-if="visibleJoinGroup">
        ...
        <a-button @click="joinGroup" type="primary">add a group</a-button>
      </div>
    </a-modal>
    <a-modal v-model="visibleAddFriend" footer="" title="Search user">
      <div style="display:flex" v-if="visibleAddFriend">
        ...
        <a-button @click="addFriend" type="primary">add friend</a-button>
      </div>
    </a-modal>
  </div>
</template>
